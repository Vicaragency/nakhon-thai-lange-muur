...
export const LANGE_MUUR: Brand = {
  ...
  heroDishes: [
    { src: "/images/lm-noodles.png", alt: "Vers bereid Chinees gerecht" },
    { src: "/images/lm-chicken.png", alt: "Vers bereid Chinees gerecht" },
    { src: "/images/lm-tofu.png", alt: "Vers bereid Chinees gerecht" },
